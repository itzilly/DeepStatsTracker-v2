...
#   stars
    ...
    total_resources = data.get('eight_one_iron_resources_collected_bedwars', 0) + data.get(
        'eight_one_gold_resources_collected_bedwars', 0) + data.get('eight_one_diamond_resources_collected_bedwars',
                                                                    0) + data.get(
        'eight_one_emerald_resources_collected_bedwars', 0)
    iron_per_game = data.get('eight_one_iron_resources_collected_bedwars', 0) / data.get(
        'eight_one_games_played_bedwars', 1)
    gold_per_game = data.get('eight_one_gold_resources_collected_bedwars', 0) / data.get(
        'eight_one_games_played_bedwars', 1)
    diamonds_per_game = data.get('eight_one_diamond_resources_collected_bedwars', 0) / data.get(
        'eight_one_games_played_bedwars', 1)
    emeralds_per_game = data.get('eight_one_emerald_resources_collected_bedwars', 0) / data.get(
        'eight_one_games_played_bedwars', 1)
    total_resources_per_game = (data.get('eight_one_iron_resources_collected_bedwars', 0) + data.get(
        'eight_one_gold_resources_collected_bedwars', 0) + data.get('eight_one_diamond_resources_collected_bedwars',
                                                                    0) + data.get(
        'eight_one_emerald_resources_collected_bedwars', 0)) / data.get('eight_one_games_played_bedwars', 1)
